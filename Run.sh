...
echo This Script Is Created By Raiizer >update.pandahackers
...
echo -e "\e[4;34mThis Tool Is Created By Raiizer \e[0m" #underline+blue
echo " "
...
echo "Enter 6 If You're a Nigga"
read ch
if [ $ch -eq 1 ];then
clear
echo -e "\e[1;32m"
...
toilet -f pagga -F border Raiizer | lolcat
echo " "
exit 0
else
